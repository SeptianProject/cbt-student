     ...
     return (
          <ProtectedRoute>
               <div className="relative flex flex-col justify-between gap-10 p-4 sm:p-8 md:p-10 lg:p-12 min-h-screen bg-white">
                    {confirmed && <div className='absolute top-0 left-0 w-full h-full flex items-center justify-center z-20'>
                         ...
                         <div className='bg-black w-full h-full absolute top-0 left-0 opacity-40 select-none'></div>
                    </div>}
